...
# _C.MODEL.ROI_BOX_HEAD.CONV_FC_THRESHOLD = 224 
_C.MODEL.ROI_BOX_HEAD.MASK_LOSS = [1, 1, 1, 1]
_C.MODEL.ROI_BOX_HEAD.EVALUATION_FLAGS = [1, 1, 1, 1]
...
# Neighbor
_C.MODEL.ROI_BOX_HEAD.NEIGHBOR_CONV_EXPAND = 1.3
_C.MODEL.ROI_BOX_HEAD.NEIGHBOR_FC_EXPAND = 1.0
_C.MODEL.ROI_BOX_HEAD.ROI_EXPAND = False
_C.MODEL.ROI_BOX_HEAD.NONLOCAL_CLS_NUM_GROUP= 4
_C.MODEL.ROI_BOX_HEAD.NONLOCAL_CLS_NUM_STACK = 0
_C.MODEL.ROI_BOX_HEAD.NONLOCAL_REG_NUM_GROUP= 4
_C.MODEL.ROI_BOX_HEAD.NONLOCAL_REG_NUM_STACK = 0
_C.MODEL.ROI_BOX_HEAD.NONLOCAL_SHARED_NUM_GROUP= 4
_C.MODEL.ROI_BOX_HEAD.NONLOCAL_SHARED_NUM_STACK = 2
_C.MODEL.ROI_BOX_HEAD.NONLOCAL_USE_SOFTMAX = False
_C.MODEL.ROI_BOX_HEAD.NONLOCAL_USE_FFCONV = True
_C.MODEL.ROI_BOX_HEAD.NONLOCAL_USE_ATTENTION = True
_C.MODEL.ROI_BOX_HEAD.NONLOCAL_USE_BN = True
_C.MODEL.ROI_BOX_HEAD.NONLOCAL_USE_RELU = True
_C.MODEL.ROI_BOX_HEAD.NONLOCAL_INTER_CHANNELS = 512
_C.MODEL.ROI_BOX_HEAD.NONLOCAL_OUT_CHANNELS = 1024
...
_C.TEST.EVALUATION_FLAGS = [1, 1, 1, 1]
